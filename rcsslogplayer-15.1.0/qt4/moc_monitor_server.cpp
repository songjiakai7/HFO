...
void MonitorServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        MonitorServer *_t = static_cast<MonitorServer *>(_o);
        switch (_id) {
        case 0: _t->sendToClients(); break;
        case 1: _t->handleReceive(); break;
        case 2: _t->removeDisconnectedClient(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData MonitorServer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MonitorServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MonitorServer,
      qt_meta_data_MonitorServer, &staticMetaObjectExtraData }
};
