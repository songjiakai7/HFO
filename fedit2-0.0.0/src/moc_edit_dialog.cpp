/****************************************************************************
** Meta object code from reading C++ file 'edit_dialog.h'
**
...
#error "The header file 'edit_dialog.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_EditDialog[] = {
    "EditDialog\0\0viewUpdated()\0on\0shown(bool)\0"
    "validateBallCoordinate()\0resetChanges()\0"
    "applyToField()\0updateData()\0"
};
...
void EditDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->shown((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->validateBallCoordinate(); break;
        case 3: _t->resetChanges(); break;
        case 4: _t->applyToField(); break;
...
// SIGNAL 0
void EditDialog::viewUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void EditDialog::shown(bool _t1)
{
